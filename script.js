...
navToggle.addEventListener('click', () => {
  ...
  let currrent_singer_name = document.querySelector('#current_singer_name');
  ...
  /*songs duration*/
  let current_duration = document.querySelector('.controls .progress_part #current_duration');
  let total_duration = document.querySelector('.controls .progress_part #total_duration');
